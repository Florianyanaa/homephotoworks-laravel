        ...
        <div class="grid-3 grid-4">
            ...
            <div class="service-card location-card">
                <div class="location-map">
                    <iframe
                        src="<?php echo e('https://www.google.com/maps?q=' . $b['lat'] . ',' . $b['lng'] . '&z=16&output=embed'); ?>"
                        loading="lazy"
                ...
                <div class="service-body">
                    ...
                    <a href="<?php echo e($b['maps_url']); ?>" target="_blank" rel="noopener" class="btn btn-outline btn-block">Buka Maps</a>
                </div>
            </div>
