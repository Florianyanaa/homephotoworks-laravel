            ...
            <tr style="<?php echo e($m->is_read ? '' : 'background:#fafafa; font-weight:600;'); ?>">
                ...
                <td class="action-icons">
                    <?php if($m->phone): ?>
                        ...
                        ?>
                        <a href="<?php echo e('https://wa.me/' . $customerPhone . '?text=' . rawurlencode("Halo {$m->name}, terima kasih sudah menghubungi Home Photoworks.")); ?>" target="_blank" rel="noopener">Hubungi via WA</a>
                    <?php else: ?>
