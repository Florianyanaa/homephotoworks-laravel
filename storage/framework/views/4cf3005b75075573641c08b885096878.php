...
<section class="section">
    <div class="container">
        <img src="<?php echo e($svcImgPath && file_exists($svcImgPath) ? asset('uploads/services/' . $service->image) : asset('img/placeholder-service.jpg')); ?>"
                ...
                <div class="service-body" style="display:flex; flex-direction:column; flex:1;">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(!auth()->user()->isAdmin()): ?>
                            <a href="<?php echo e(route('user.booking.create', ['service_id' => $service->id, 'tier' => $tier['key']])); ?>" class="btn btn-primary btn-block">Booking <?php echo e($tier['label']); ?></a>
                        <?php endif; ?>
                    <?php else: ?>
