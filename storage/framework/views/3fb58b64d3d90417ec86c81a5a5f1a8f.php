...
<section class="section">
    <div class="container split">
        <img src="<?php echo e($galImgPath && file_exists($galImgPath) ? asset('uploads/gallery/' . $gallery->image) : asset('img/placeholder-gallery.jpg')); ?>"
    ...
    <div class="container">
        ...
        <div class="gallery-grid">
            ...
            <a href="<?php echo e(route('galeri.show', $g->id)); ?>" class="gallery-item gallery-item-link">
                <img src="<?php echo e($otherImgPath && file_exists($otherImgPath) ? asset('uploads/gallery/' . $g->image) : asset('img/placeholder-gallery.jpg')); ?>" alt="<?php echo e($g->title); ?>">
